          ...
          <div className="space-y-6 md:space-y-8">
            <div className="space-y-4 md:space-y-6">
              <h1 className={headerText}>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF9D23] to-[#43C6AC]">
                 Readora
                </span>
                <br />
              ...
              <p className={paragraphText}>
               Delve into curated literary paths that expand perception and nourish the mind.
               Thoughtfully designed content for the modern intellect.
              </p>
            </div>
              ...
              <div className={formContainer}>
                <div className={inputWrapper}>
                  ...
                  <div className="relative flex items-center">
                    <Search className="ml-4 md:ml-5 w-5 h-5 md:w-6 md:h-6 text-gray-500 group-focus-within:text-[#205781]" />
                    <input
                      type="text"
                      value={searchQuery}
                      onChange={(e) => setSearchQuery(e.target.value)}
                      placeholder="Search authors, titles, or concepts...and more"
