...
export const navbarStyles = {
  ...
  logoGradient: "absolute -inset-3 rounded-full opacity-0 blur-xl group-hover:opacity-30 transition-opacity bg-gradient-to-r from-[#FF9D23] to-[#F8FFAE]",
  logoImage: "h-15 w-15 rounded-full z-10",
  logoText: "text-xl font-bold bg-gradient-to-r from-[#FF9D23] to-[#C14600] bg-clip-text text-transparent",
  logoUnderline: "h-0.5 w-0 bg-gradient-to-r from-[#FF9D23] to-[#C14600] group-hover:w-full transition-all duration-500",
...
export const container =
  "min-h-screen flex items-center justify-center px-4 pt-20 md:pt-24 pb-12 relative bg-gradient-to-br from-[#FF9D23]/90 to-[#C14600]/90";

export const glassBox =
  "backdrop-blur-2xl bg-white/95 rounded-2xl md:rounded-[2rem] shadow-lg md:shadow-2xl max-w-7xl w-full mx-4 p-6 md:p-8 lg:p-12 relative overflow-hidden";
...
export const wordClass =
  "absolute text-2xl sm:text-3xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-[#ECE852] to-[#FF9D23] transition-all duration-500";
...
export const searchButton =
  "px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-[#FF9D23] to-[#C14600] text-white rounded-lg md:rounded-xl font-medium hover:shadow-lg transition-all duration-300 shadow-md flex items-center gap-2 justify-center hover:-translate-y-0.5 text-sm md:text-base";
...
export const statNumber = "text-xl md:text-2xl font-bold text-[#C14600]";
...
export const imageWrapper =
  "relative w-full max-w-md lg:max-w-lg aspect-square bg-gradient-to-br from-white/20 to-[#FCF259]/10 rounded-xl md:rounded-2xl overflow-hidden";
...
export const overlayEffect =
  "absolute inset-0 mix-blend-overlay bg-gradient-to-t from-[#C14600]/10 to-transparent";
...
export const ourBestSellersStyles = {
  ...
  gradientText: "bg-gradient-to-r from-[#FCF259] to-[#C14600] bg-clip-text text-transparent",
  ...
  qtyBtn: "text-[#FBA518] hover:text-[#C14600] p-1 md:p-1.5",
  qtyText: "text-gray-900 font-medium w-6 text-center",

  addButton: "flex items-center gap-1.5 md:gap-2 px-4 md:px-6 py-2 md:py-3 bg-gradient-to-r from-[#C14600] to-[#EB5A3C] text-white rounded-lg md:rounded-xl font-medium hover:scale-[1.02] transition-transform text-sm md:text-base",
...
export const homeBooksStyles = {
  section: "py-20 bg-gradient-to-br from-[#F5EEDD]/90 to-[#F5EEDD] relative",
  container: "container mx-auto px-4 md:px-6",
  card: "bg-white rounded-2xl shadow-lg p-8 md:p-12",
  heading: "text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#FFC145] to-[#C14600] bg-clip-text text-transparent mb-4",
  headingLine: "h-1 w-20 bg-gradient-to-r from-[#FFC145] to-[#C14600] rounded-full mx-auto",
  grid: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8",
  bookCard: "group relative",
  imageWrapper: "relative h-72 overflow-hidden rounded-xl border-4 border-[#C14600]/20 mb-4",
  ...
  discountPrice: "text-lg font-bold text-[#C14600]",
  originalPrice: "text-gray-400 line-through",
  actualPrice: "text-lg font-bold text-[#FFC145]",
  qtyBox: "flex items-center justify-between bg-[#FFC145]/10 px-4 py-2 rounded-lg",
  qtyBtn: "text-[#FFC145] hover:text-[#F1BA88] cursor-pointer",
  addBtn:
    "w-full flex items-center cursor-pointer justify-center gap-2 px-4 py-2 bg-gradient-to-r from-[#FFC145] to-[#F1BA88] text-black rounded-lg hover:shadow-lg transition-all",
  viewBtnWrapper: "flex justify-center mt-12",
  viewBtn:
    "group inline-flex items-center justify-center px-6 py-3 rounded-full border-2 border-[#FFC145] text-[#C14600] hover:bg-[#FF9D23]/10 transition-all",
...
export const homeAboutStyles = {
  ...
  bgBlur1: "absolute top-1/4 right-1/4 w-96 h-96 rounded-full bg-[#C14600]/20 blur-[100px]",
  bgBlur2: "absolute bottom-1/4 left-1/4 w-96 h-96 rounded-full bg-[#C14600]/20 blur-[100px]",
  ...
  imageGlow: "absolute -inset-4 bg-gradient-to-r from-[#FFC145] to-[#C14600] rounded-2xl blur opacity-0 group-hover:opacity-20 transition-opacity duration-500",
  imageContainer: "relative overflow-hidden rounded-xl border-4 border-[#C14600]/20",
  aboutImage: "w-full h-auto rounded-xl transition-transform duration-700 hover:rotate-1",
  aboutHeader: "text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#FFC145] to-[#C14600] bg-clip-text text-transparent mb-4",
  underline: "h-1 w-20 bg-gradient-to-r from-[#FFC145] to-[#C14600] rounded-full",
  aboutText: "text-gray-600 leading-relaxed",
  statGrid: "grid grid-cols-1 md:grid-cols-3 gap-6",
  statCard: "bg-white border-2 border-[#C14600]/20 rounded-xl p-4 text-center shadow-lg",
  statIconWrap: "inline-flex items-center justify-center p-3 bg-[#FFC145] rounded-full mb-3",
  statIcon: "h-6 w-6 text-[#C14600]",
  statValue: "text-2xl font-bold text-gray-900",
  statLabel: "text-sm text-gray-600",
  aboutButton: "group inline-flex items-center justify-center px-6 py-3 rounded-full bg-gradient-to-r from-[#FFC145] to-[#C14600] text-black font-medium shadow-sm hover:shadow-[#C14600]/25 transition-all duration-300",
  arrowIcon: "ml-2 h-4 w-4 transition-transform group-hover:translate-x-1",
  sectionHeader: "text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#C14600] to-[#FFC145] bg-clip-text text-transparent mb-4",
  headerUnderline: "h-1 w-20 mx-auto bg-gradient-to-r from-[#C14600] to-[#FFC145] rounded-full",
  ...
  bookCardGlow: "absolute -inset-0.5 bg-gradient-to-r from-[#FFC145] to-[#C14600] rounded-xl blur opacity-0 group-hover:opacity-30 transition-opacity duration-500",
  bookCard: "relative bg-white border-2 border-[#C14600]/20 rounded-xl overflow-hidden transition-all duration-500 hover:shadow-lg hover:shadow-[#FFC145]/20 h-full flex flex-col",
  ...
  bookAuthor: "text-sm text-[#C14600] mb-3",
  bookDesc: "text-gray-600 text-sm mb-4 flex-grow",
  discoverLink: "inline-flex items-center text-[#C14600] hover:text-[#FFC145] transition-colors",
...
export const footerStyles = {
  footer: "bg-gray-100 border-t border-[#C14600]/20 pt-16 pb-8 relative",
  container: "container mx-auto px-4 md:px-6",
  ...
  logoText: "text-2xl font-bold bg-gradient-to-r from-[#FFC145] to-[#C14600] bg-clip-text text-transparent",
  aboutText: "text-gray-600 text-sm leading-relaxed",
  socialWrap: "flex gap-3",
  socialButton: "flex items-center justify-center w-9 h-9 rounded-full bg-white border border-[#FFC145]/30 hover:border-[#FFC145] hover:bg-[#FFC145]/20 transition-all duration-300",
  socialIcon: "h-4 w-4 text-[#FFC145] transition-colors duration-300",
  quickLinksBlock: "space-y-4",
  quickLinksTitle: "text-lg font-semibold text-gray-900 mb-2",
  quickLinksList: "space-y-2.5",
  quickLinkItem: "group inline-flex items-center text-gray-600 hover:text-[#C14600] transition-colors duration-300 text-sm",
  quickLinkDot: "w-1.5 h-1.5 bg-[#C14600] rounded-full mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200",
  ...
  formWrap: "relative",
  input: "w-full px-4 py-2.5 bg-white border border-[#C14600]/30 rounded-lg text-gray-600 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FF9D23]/50 transition-all pr-12",
  button: "absolute right-1 top-1 p-2 bg-gradient-to-r from-[#C14600] to-[#FFC145] rounded-md text-white hover:scale-105 transform transition-all shadow-sm hover:shadow-[#FF9D23]/30",
  ...
  contactIcon: "h-4 w-4 text-[#FFC145] mr-2 mt-1 flex-shrink-0",
  contactRow: "flex items-center text-gray-600 text-sm",
  contactIconInline: "h-4 w-4 text-[#FFC145] mr-2 flex-shrink-0",
  copyrightWrap: "border-t border-[#FFC145]/20 pt-6 text-center",
...
export const inputStyle =
  "w-full pl-10 pr-4 py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C14600] focus:border-[#FFC145]"
export const textareaStyle =
  "w-full pl-10 pr-4 py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C14600] focus:border-[#FFC145]"
export const errorStyle = "text-red-500 text-sm mt-1"

export const submitButtonStyle =
  "w-full px-6 py-3 bg-[#C14600] text-white rounded-lg font-medium hover:bg-[#C14600] transition-colors disabled:opacity-70"
...
const aboutStyles = {
  ...
  heading: "text-6xl md:text-7xl font-black bg-gradient-to-r from-[#C14600] to-[#FFC145] bg-clip-text text-transparent mb-6 leading-tight",
  underline: "absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-48 h-2 bg-gradient-to-r from-[#C14600] to-[#FFC145] rounded-full",
  subText: "text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium",

  statsSection: "py-20 bg-gradient-to-br from-[#C14600]/5 via-[#FFC145]/5 to-[#FF9D23]/5",
  statCard: "bg-white/95 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-[#FFC145]/10 transition-transform hover:-translate-y-2",
  statIconWrapper: "w-16 h-16 rounded-2xl bg-gradient-to-r from-[#FFC145] to-[#C14600] flex items-center justify-center mb-6 shadow-lg",
  statValue: "text-5xl font-black text-[#C14600] mb-2",
  ...
  aboutOverlay: "absolute inset-0 bg-gradient-to-t from-[#FFC145]/30 to-transparent",
  aboutCaption: "absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-[#C14600]/80 to-transparent",
  ...
  aboutHeading: "text-5xl font-black bg-gradient-to-r from-[#FFC145] to-[#C14600] bg-clip-text text-transparent",
  aboutParagraph: "text-lg text-gray-700 leading-relaxed",
  aboutBoxGrid: "grid grid-cols-1 md:grid-cols-2 gap-6",
  aboutBox: "p-6 bg-white/95 backdrop-blur-lg rounded-2xl shadow-xl border border-[#FFC145]/10",
  aboutBoxHeading: "text-2xl font-bold text-[#C14600] mb-3",
  aboutBoxText: "text-gray-600",

  teamSection: "py-20 bg-gradient-to-br from-[#C14600]/5 to-[#FFC145]/5",
  sectionTitle: "text-5xl font-black bg-gradient-to-r from-[#C14600] to-[#FFE893] bg-clip-text text-transparent",
  sectionUnderline: "mt-6 h-1 w-24 mx-auto bg-gradient-to-r from-[#FFE893] to-[#C14600] rounded-full",
  teamCard: "group relative bg-white/95 backdrop-blur-lg rounded-[2rem] p-6 shadow-2xl border border-[#FF9D23]/10 transition-transform hover:-translate-y-3",
  ...
  teamOverlay: "absolute inset-0 bg-gradient-to-t from-[#C14600]/40 to-transparent",
  teamName: "text-2xl font-bold text-gray-900 mb-1",
  teamPosition: "text-lg text-[#FF9D23] font-medium mb-6",
  socialIcon: "p-2 rounded-full bg-gradient-to-r from-[#C14600] to-[#FFE893] text-white hover:shadow-lg transition-all hover:scale-110",

  branchSection: "py-20",
  branchCard: "bg-white/95 backdrop-blur-lg rounded-2xl p-6 shadow-2xl border border-[#FFE893]/10 transition-transform hover:-translate-y-2",
  ...
  branchOverlay: "absolute inset-0 bg-gradient-to-t from-[#C14600]/30 to-transparent",
  branchInfoWrapper: "space-y-4",
  branchLocationWrapper: "flex items-center space-x-3",
  branchLocation: "text-xl font-semibold text-[#C14600]",
...
export const booksPageStyles = {
  container: "min-h-screen pt-24 pb-16 bg-gradient-to-br from-[#F8FAFC] to-[#F8FAFC]",
  ...
  headerTitle: "text-4xl md:text-5xl font-bold text-transparent pb-2 md:pb-4 bg-clip-text bg-gradient-to-r from-[#FFE893] to-[#C14600]",
  ...
  searchInput: "w-full pl-12 md:pl-16 pr-4 md:pr-6 py-3 md:py-4 bg-white/90 backdrop-blur-sm border-0 rounded-xl md:rounded-2xl shadow-md md:shadow-lg focus:ring-2 focus:ring-[#C14600]/30 text-base md:text-lg placeholder-gray-400 text-gray-700 transition-all",
  ...
  selectBox: "w-full md:w-auto px-4 md:px-5 py-2 md:py-3 bg-white/90 backdrop-blur-sm border-0 rounded-lg md:rounded-xl shadow-md md:shadow-lg text-gray-700 focus:ring-2 focus:ring-[#C14600]/30 text-sm md:text-base",
  ...
  cartButtons: "flex cursor-pointer items-center gap-1 md:gap-2 px-3 md:px-4 py-2 md:py-2.5 bg-gradient-to-r from-[#C14600] to-[#FFE893] text-white rounded-lg md:rounded-xl text-sm md:text-base font-medium hover:shadow-md hover:scale-[1.02] transition-all"
};
...
export const contactPageStyles = {
  ...
  inputStyle:
    "w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-[#C14600] focus:border-[#C14600] text-gray-700",
  errorStyle: "text-sm text-red-500 mt-1",
  textareaStyle:
    "w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-[#C14600] focus:border-[#C14600] text-gray-700 resize-none",
  submitButtonStyle:
    "w-full flex justify-center items-center bg-[#C14600] hover:bg-[#FFE893] text-white font-semibold py-2 px-4 rounded-md shadow-md transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed",
...
export const styles = {
  ...
  checkoutBtn: "w-full flex items-center justify-center gap-2 px-5 py-3 md:px-6 md:py-4 bg-gradient-to-r from-[#FFE893] to-[#C14600] text-white rounded-lg md:rounded-xl font-semibold hover:opacity-90 transition-opacity text-sm md:text-base mb-3 md:mb-4",
...
export const Signup = {
  ...
  input: "w-full pl-10 pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#C14600] focus:border-[#C14600] text-gray-800 placeholder-gray-400",
  passwordInput: "w-full pl-10 pr-10 py-3 border rounded-lg focus:ring-2 focus:ring-[#C14600] focus:border-[#C14600] text-gray-800 placeholder-gray-400",
  togglePassword: "absolute right-3 top-3.5 text-gray-400",
  submitBtn: "w-full bg-[#C14600] text-white py-3 rounded-lg hover:bg-[#FFE893] transition-colors",
  footerText: "mt-6 text-center text-gray-600",
  link: "text-[#FFE893] hover:underline",
...
export const loginStyles = {
  ...
  inputWrapper: "relative",
  input:
    "w-full pl-10 pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#FF9D23] focus:border-[#C14600] text-gray-800 placeholder-gray-500",
  passwordInput:
    "w-full pl-10 pr-10 py-3 border rounded-lg focus:ring-2 focus:ring-[#C14600] focus:border-[#FF9D23] text-gray-800 placeholder-gray-500",
  togglePassword: "absolute right-3 top-3.5 text-gray-400",
  submitButton:
    "w-full bg-[#C14600] text-white py-3 rounded-lg hover:bg-[#C14600] transition-colors disabled:opacity-70",
  footerText: "mt-6 text-center text-gray-600",
  footerLink: "text-[#FF9D23] hover:underline",
  ...
  homepageButton:
    "w-full bg-[#C14600] text-white py-3 rounded-lg hover:bg-[#C14600] transition-colors mb-2",
  signOutButton:
